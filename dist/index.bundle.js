...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_moment_timezone__ = __webpack_require__(24);
...
const initParm = data => {
  ...
  const currentDateTime = __WEBPACK_IMPORTED_MODULE_1_moment_timezone___default()().tz('Asia/Taipei').format('YYYY/MM/DD HH:mm:ss'); // 取得交易時間
  baseParam = {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment_timezone__ = __webpack_require__(24);
...
const queryTradeInfo = merchantTradeNo => {
   return new Promise((resolve, reject) => {
      // 取得目前時間戳記
      const timestamp = __WEBPACK_IMPORTED_MODULE_4_moment_timezone___default()().valueOf().toString().substring(0, 10);
...
var moment = module.exports = __webpack_require__(25);
moment.tz.load(__webpack_require__(26));
